        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RegionTranslates_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_RegionTranslates_AspNetUsers_UpdatedById",
                        column: x => x.UpdatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductCategoryTranslates_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ProductCategoryTranslates_AspNetUsers_UpdatedById",
                        column: x => x.UpdatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ProductCategoryTranslates_ProductCategories_ProductCategory~",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductTranslates_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ProductTranslates_AspNetUsers_UpdatedById",
                        column: x => x.UpdatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsBought = table.Column<bool>(type: "boolean", nullable: true),
                    BoughtAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    BoughtMoney = table.Column<double>(type: "double precision", nullable: true),
                    IsDelivery = table.Column<bool>(type: "boolean", nullable: true),
                    DeliveryAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductCategoryTranslates_CreatedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductCategoryTranslates_UpdatedById",
                table: "ProductCategoryTranslates",
                column: "UpdatedById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductTranslates_CreatedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductTranslates_UpdatedById",
                table: "ProductTranslates",
                column: "UpdatedById");

            migrationBuilder.CreateIndex(
                name: "IX_RegionTranslates_CreatedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RegionTranslates_UpdatedById",
                table: "RegionTranslates",
                column: "UpdatedById");
